    ...
    <div style={{ padding:"0 16px" }}>
      ...
      {legs.length===0 ? (
        ...
        <>
          ...
          <button style={{ width:"100%", padding:"14px", background:`linear-gradient(135deg, ${C.accent}, #d97706)`, border:"none", borderRadius:10, cursor:"pointer", color:"#0f1117", fontSize:14, fontWeight:800, letterSpacing:0.3 }}>Place Accumulator Bet →</button>
        </>
      )}
    </div>
  );
